...
function loader_notification() {
    ...
    $.get(NOTIFICATION_JSON,function(resp) {
        ...
        if(resp.total>0) {
            ...
            $('.notifications-menu #list_notifications').empty();
            ...
            $.each(resp.items,function(i,obj) {
                ...
                <div class="d-flex flex-stack py-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mb-0 me-2">
                            <a href="${ADMIN_PATH}/notifications/read/${obj.id}?m=0" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Notification</a>
                            <div class="text-gray-400 fs-7">${obj.content}</div>
                        </div>
                    </div>

                    <span class="badge badge-light fs-8">${obj.time_ago}</span>
                </div>
            `;
            })
